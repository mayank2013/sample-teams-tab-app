...
/**
 * Implementation of channel tab configuration page
 */
export const ChannelTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            contentUrl: host + "/channelTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/channelTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "channel tab",
            removeUrl: host + "/channelTab/remove.html?theme={theme}",
